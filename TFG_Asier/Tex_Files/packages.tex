...
\usepackage[T1]{fontenc}            % Codificación moderna de fuentes
\usepackage{lmodern}                % Fuente vectorial (soluciona el error de microtype)
...
% GEOMETRIA
\usepackage[paper=A4]{typearea} %--> choca con el geometry
...
\usepackage[acronym]{glossaries}		% ,nonumberlist
...
%\usepackage{everypage} --> Desactualizado
\usepackage{lipsum}
...
\egroup\fi}
\AddToHook{shipout/page}{\Lpagenumber}% Code
%\begin{landscape}
% Text
%\end{landscape}
...
% Para enlaces visibles
\definecolor{UPMblue}{RGB}{0, 89, 153} % Color azul de la UPM
\definecolor{black}{RGB}{0, 0, 0}
\hypersetup{
    colorlinks=true,
    linkcolor=black, % Color de los enlaces internos (índice, figuras)
    citecolor=UPMblue, % Color de las citas bibliográficas
    urlcolor=UPMblue   % Color de los enlaces web
}
