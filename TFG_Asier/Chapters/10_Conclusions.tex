...
The hot case generates the greatest electrical energy and experiences the
strongest final discharge because of its late eclipse and higher demand. The
cold case finishes with the lowest state of charge by a small margin, despite
its lower demand, while remaining thermally restricted throughout the
simulation. None of the cases produces unserved load. These results show that
battery operation cannot be determined from the generated or demanded energy
alone, since their temporal distribution and the active operating limits are
also relevant.
